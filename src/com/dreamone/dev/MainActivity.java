...
//    private static final String REDIRECT_URL = "http://www.acer.com.cn";//Acer平板电脑
    ...
    private RequestListener updateListner = new RequestListener() {
        ...
        public void onWeiboException(WeiboException e) {
            Log.d("SWJ", "updateListner onWeiboException.", e);
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAuthInfo = new AuthInfo(this, Constants.WB.APP_KEY, Constants.WB.REDIRECT_URL, Constants.WB.SCOPE);
        ...
        mUpdateBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Api unsupported in this version.", Toast.LENGTH_SHORT).show();
